...
<head>
    ...
    <title>EAD List of Competition</title>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <nav>
            <ul class="box-primary-nav">
                ...
                <li class="box-social"><a href=https://www.instagram.com/ead.fse/?hl=id><i class="ion-social-instagram-outline"></i></a></li>
        ...
        <section class="box-intro">
            <div class="table-cell">
                ...
                <h5>everything you need to build your personality</h5>
                <input type="submit" value="LOGIN">
                <a href="tambah.php"><input type="submit" value="DAFTAR AKUN"></a>
    ...
    <footer>
        <div class="container-fluid">
            <p class="copyright">EAD.fse 2019</p>
        </div>
    </footer>
    <!-- end footer -->
